...
const controlRecipes = async function() {
    try {
        ...
        (0, _recipeViewJsDefault.default).update(_modelJs.getSearchResultsPage());
...
var _helpresJs = require("./helpres.js");
const state = {
    recipe: {},
    search: {
        query: '',
...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _helpresJs.getJSON)(`${(0, _configJs.API_URL)}${id}`);
        ...
        else state.rec.bookmarked = false;
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _helpresJs.getJSON)(`${(0, _configJs.API_URL)}?search=${query}`);
        console.log(data);
...
const deleteBookmark = function(id) {
    ...
    if (id === state.recipe.id) state.recipe.bookmarked = fale;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config.js":"2hPh4","./helpres.js":"5RFd4"}],"2hPh4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5RFd4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== '') curEl.textContext = newEl.textContent;
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      `;
        // Page 1, and the re are NO other page
        return ``;
    }
}
...
},{"./View.js":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView.js":"6tKHS"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire7e89", {}, "./", "/")
