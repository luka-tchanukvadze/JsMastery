...
*/
//1
const huskyWeight = breeds.find(item => item.breed === 'Husky').averageWeight;
console.log(huskyWeight);
...
// 3
const allActivities = breeds.map(dogs => dogs.activities).flat();
console.log(allActivities);
